...
function explicitLinuxFeatureIds(featuresRoot) {
...
function defaultEnabledLinuxFeatureIds(options = {}) {
...
function enabledLinuxFeatureIds(options = {}) {
  ...
  const enabledIds = new Set(defaultEnabledLinuxFeatureIds({ ...options, featuresRoot }));
  for (const id of explicitLinuxFeatureIds(featuresRoot)) {
    enabledIds.add(id);
  }
